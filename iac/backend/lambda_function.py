...
# Configuration
DDB_TABLE = 'proj3_ImageProcessingTable'
REFERENCE_BUCKET = 'proj3-uco-cicc-media-group6'
UPLOAD_BUCKET = 'proj3-uco-cicc-media-group6'  # Bucket for user-uploaded images
REFERENCE_IMAGES = [
    'proj3_photos_Feb17/faces1_Feb17.jpg',
    'proj3_photos_Feb17/faces2_Feb17.jpg',
    'proj3_photos_Feb17/faces3_Feb17.jpg'
]
# New: Configuration for the reference text image (for Textract)
TEXT_REFERENCE_IMAGE = 'proj3_photos_Feb17/names1_Feb17.jpg'

similarity_threshold = 80.0  # For face comparisons expressed as a percentage similarity threshold
...
def lambda_handler(event, context):
    ...
    source_urls = []
    uploaded_image_key = None  # to store key of the first uploaded image successfully detected during face detection step
    ...
    # Detect faces in the uploaded image using detect_faces detection API
    try:
    ...
    # For each reference image, detect faces and compare with uploaded faces
    for ref_key in REFERENCE_IMAGES:
        try:
            # Detect faces in the reference image  using detect_faces
